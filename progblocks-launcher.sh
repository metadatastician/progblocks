...
#
# ============================================================================
# progblocks-launcher.sh — ProgBlocks
# ============================================================================
...
APP_NAME="progblocks"
APP_DISPLAY="ProgBlocks"
APP_DESC="Standalone Advanced Presentation Component for Rich Code Blocks"
APP_CATEGORIES="Development;Utility;Documentation;"
APP_GENERIC_NAME="ProgBlocks"
...
CONFIG_FILE="/home/hyperpolymath/developer/meta-repos/progblocks/progblocks.launcher.a2ml"

URL="http://localhost:8080"
APP_PORT="8080"
WAIT_SECONDS="10"

PID_FILE="${XDG_RUNTIME_DIR:-${TMPDIR:-/tmp}}/progblocks.pid"
LOG_FILE="${XDG_STATE_HOME:-$HOME/.local/state}/progblocks/progblocks.log"
...
[runtime].startup-command-search or [runtime].command in progblocks.launcher.a2ml."
            return 1
        fi
    fi
