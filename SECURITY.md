...
1. Navigate to [Report a Vulnerability](https://github.com/metadatastician/progblocks/security/advisories/new)
...
- This repository (`metadatastician/progblocks`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/metadatastician/progblocks/security/advisories)
...
When using Progblocks, we recommend:
...
- [Security Advisories](https://github.com/metadatastician/progblocks/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/metadatastician/progblocks/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/metadatastician/progblocks/discussions) |
...
*Thank you for helping keep Progblocks and its users safe.* 🛡️
